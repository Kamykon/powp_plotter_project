...
public class TestPlotSoftPatterns
{
	...
	private static void setupPresetTests(Context context) {
		...
		context.addTest("Rectangle", (a) -> Factory.drawRectangle(0, 0, 10, 20).execute(Application.getComponent(DriverManager.class).getCurrentPlotter()));
		context.addTest("Circle", (a) -> Factory.drawCircle(20, 20, 10	0).execute(Application.getComponent(DriverManager.class).getCurrentPlotter()));
	}
	...
	private static void setupDrivers(Context context) {
		...
		IPlotter plotter = new DrawerAdapter(Application.getComponent(DrawPanelController.class));
		context.addDriver("Buggy Simulator", plotter);

		IPlotter linePlotter = new DrawerAdapter(Application.getComponent(DrawPanelController.class));
		context.addDriver("LinePlotter Simulator", linePlotter);
